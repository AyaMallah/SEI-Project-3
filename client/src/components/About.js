    ...
    <>
      <div className="background d-flex justify-content-between">
        ...
        <div className="code-team d-flex">
          ...
          <img variant="top" className="img-fuild" src=" https://res.cloudinary.com/inetab/image/upload/v1625566544/SEI-Project-3/mern-stack.png" />
      ...
      <CardGroup>
        <Card className="burt">
          <img className="image-border animate__animated animate__zoomIn" variant="top" src="https://res.cloudinary.com/inetab/image/upload/v1625750523/SEI-Project-3/0003_35_u9ozus.jpg" />
          <h3>Burt</h3>
          <p>
        ...
        <Card className="luna">
          <img className="image-border animate__animated animate__zoomIn luna-img" src="https://res.cloudinary.com/dhrxw6zhp/image/upload/v1628515567/lighter_fsoinw.jpg" />
          <h3>Luna</h3>
          <p>
