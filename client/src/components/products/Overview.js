      ...
      <div className="cat-page cat-section">
        ...
        <div className="dog-wrapper">
          <div className="meals-hero">
            ...
            <img src="https://res.cloudinary.com/dhrxw6zhp/image/upload/v1628515200/vgwv5ywsz6dhrl7cqzvm.jpg" alt="Dog Food" />
          </div>
        </div>
      ...
      <div className="dog-page dog-section">
        <div className="dog-wrapper">
          <div className="meals-hero">
            ...
            <img src="https://res.cloudinary.com/dhrxw6zhp/image/upload/v1628515127/pgfcm9klrz5yoy927kis.jpg" alt="Dog Food" />
          </div>
        </div>
